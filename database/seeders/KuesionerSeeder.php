...
class KuesionerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $kuesioner = [
            ...
            ['kode_dikti' => 'f5a2', 'kategori' => 'Masa Tunggu Lulusan', 'is_wajib' => true, 'pertanyaan' => 'Dimana lokasi tempat anda bekerja? isikan nama kota/kabupaten lokasi anda bekerja.', 'tipe_jawaban' => 'radio_lainnya', 'opsi_jawaban' => json_encode(['Jakarta Pusat', 'Jakarta Selatan', 'Bandung', 'Surabaya', 'Semarang', 'Medan', 'Makassar', 'Denpasar'])],
